...
@section('content')
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" id="formCheckOut" method="POST">
                <div class="row">
                ...
                <div class="d-block my-3">
                    ...
                    <div class="custom-control custom-radio">
                        <input id="stripe" name="paymentMethod" type="radio" class="custom-control-input"
                            required="" value="stripe" disabled>
                        <label class="custom-control-label" for="stripe">Stripe</label>
                    </div>
                </div>
                <hr class="mb-4">
                <button class="btn btn-primary btn-lg btn-block" type="submit" id="pay">Continue to checkout</button>
            </form>
        </div>
    </div>
@endsection
        ...
        $(document).ready(function() {
            ...
            $("#formCheckOut").on("submit", function(e) {
                ...
                if (validateForm()) {
                    ...
                    toastr.success('Order successfully!', 'Notification:', {
                        timeOut: 1500
                    })
